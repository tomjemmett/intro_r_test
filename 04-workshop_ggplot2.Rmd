...
<img class="center" src="img/session04/axes-description.">
...
```{r plot, out.width="50%", echo=FALSE, eval=TRUE}
ggplot(data = df) + 
  geom_point(aes(x = year, y = `time (sec)`))
```
...
Shape/colour/size `r icon::fontawesome("arrow-right")` geom all default
...
.blue[`r icon::fontawesome("plus")`] to add a layer

</br>

ggplot(data = capacity_ae) .blue[`r icon::fontawesome("plus")`] 
</br> .blue[geom_point](aes(x = dcubicles, y = dwait)) .blue[`r icon::fontawesome("plus")`] 
