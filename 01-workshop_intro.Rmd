...
magick::image_animate(image_scale(img, "600x600"), fps = 1, dispose = "previous", loop = 2)
...
</br> Slides and code are available on [`r icon::fontawesome("github")` original](https://github.com/nhs-r-community/intro_r) and [`r icon::fontawesome("github")` updated](https://github.com/Lextuga007/intro_r/tree/feature_conversion)) </br>
...
<img class="center" src="img/session01/race_car.jpg"/>

---

<img class="center" src="img/session01/roberto-nickson-unsplash.jpg"/>
...
</br>.blue[Other ways to get packages (eg. GitHub `r icon::fontawesome("github")`)]
