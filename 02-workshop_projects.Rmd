...
<img src="img/session02/cracked_setwd.jpg" width="40%"/>
...
</br> File `r icon::fontawesome("arrow-right")` New Project `r icon::fontawesome("arrow-right")` New Directory `r icon::fontawesome("arrow-right")` New Project
...
</br> If starting another projet, repeat this process.
