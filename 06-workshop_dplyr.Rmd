...
</br> When used in conjunction with summarise() the following is a message (not an error or warning): 

</br> 
> `summarise()` has grouped output by 'date'. You can override using the `.groups` argument.

</br> This is message that the [last grouping has been removed](https://stackoverflow.com/questions/62140483/how-to-interpret-dplyr-message-summarise-regrouping-output-by-x-override)
